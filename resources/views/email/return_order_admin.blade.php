                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                <td style="padding: 20px 20px 0px;">
                                                    <h3><span style="font-size: 14px;">Hello Admin,</span>
                                                    </h3>
                                                    <p
                                                        style="font-size: 16px; font-weight: 600; line-height: 26px; margin-top: 20px; margin-bottom: 0;">
                                                        <span style="font-size: 14px;">We have received a new return
                                                            order request. Below are the details for the return
                                                            order:</span>
                                                    </p>
                                                    <p
                                                        style="font-size: 16px; font-weight: 600; line-height: 26px; margin-top: 20px; margin-bottom: 0;">
